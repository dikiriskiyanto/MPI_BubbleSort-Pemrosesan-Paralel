...
## Bridged Topology
![Topology](https://github.com/dikiriskiyanto/MPI_BubbleSort-Pemrosesan-Paralel/blob/main/Topologi.png)
...
2. Navigate to that directory and edit the Python file:
   ...
   [bubble.py code](https://github.com/dikiriskiyanto/MPI_BubbleSort-Pemrosesan-Paralel/blob/main/bubble.py)

3. Run the code on the master:
    ```bash
    mpirun -np 4 -host master,slave1,slave2,slave3 python3 bubble.py
    ```
   ![Output](https://github.com/dikiriskiyanto/MPI_BubbleSort-Pemrosesan-Paralel/blob/main/output.png)
